...
8. R-spatial tutorial: @sec-05-r-spatial-tutorial
9. Practice
...
## R-spatial tutorial {#sec-05-r-spatial-tutorial}
...
:::::{.my-r-code}
:::{.my-r-code-header}
:::::: {#cnj-05-download-datar-spatial-tutorial}
...
:::::{.my-r-code}
:::{.my-r-code-header}
:::::: {#cnj-05-plotting-tutorial-map-ggplot2}
: Plotting Tutorial Map with {**ggplot2**}
::::::
:::
::::{.my-r-code-container}
```{r}
#| label: fig-05-tutorial-map-ggplot2
...
:::::{.my-r-code}
:::{.my-r-code-header}
:::::: {#cnj-05-tutorial-map-base-plot}
: Plotting Tutorial Map with `base::plot()`
::::::
:::
::::{.my-r-code-container}
```{r}
#| label: fig-05-tutorial-map-base-plot
...
::::: {.my-code-collection-icon}
:::::
:::::: {#exm-05-plotting-rivers-inside-countries-borders}
...
:::::{.my-r-code}
:::{.my-r-code-header}
:::::: {#cnj-05-plotting-rivers-inside-countries-borders-base-plot}
...
:::::{.my-r-code}
:::{.my-r-code-header}
:::::: {#cnj-05-plotting-rivers-inside-countries-borders-ggplot2}
...
:::::{.my-r-code}
:::{.my-r-code-header}
:::::: {#cnj-05-print-cities-spatial-objects}
...
:::::{.my-r-code}
:::{.my-r-code-header}
:::::: {#cnj-05-select-and-show-capitals}
